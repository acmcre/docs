...
<div class="share-section">
  ...
  <div class="position-relative">
    <pre id="email-subject">निमंत्रण: {{ site.data.config.site.event_name }} – रजिस्ट्रेशन शुरू</pre>
...
आपको {{ site.data.config.site.event_name }} के लिए आमंत्रित करते हुए खुशी हो रही है। यह CS शिक्षकों और रिसर्चर्स के लिए एक दिन का कार्यक्रम है, जिसे {{ site.data.config.organisers.host.name }} और ACM India iSIGCSE मिलकर आयोजित कर रहे हैं।

तारीख़: {{ site.data.config.site.date_display }}
समय: {{ site.data.config.site.time }}
जगह: {{ site.data.config.site.location.name }}

कार्यक्रम में Idea से Structure तक समूह-आधारित सत्र, मेंटरिंग ब्रेक और अंतिम प्रस्तुतियाँ शामिल हैं।

अधिक जानकारी और रजिस्ट्रेशन: https://forms.gle/wwrdQNRJYpffNKtb6
...
CS शिक्षकों और शोधकर्ताओं के लिए एक दिन—Idea से Structure तक सत्र, मेंटरिंग ब्रेक और सहयोग का अवसर।

रजिस्ट्रेशन लिंक: https://forms.gle/wwrdQNRJYpffNKtb6
...
कार्यक्रम में:
– सत्र 1: Ideas that work
– सत्र 2: Ideas to Structure
– सत्र 3: Structure to Paper
– सत्र 4: Presentations and wrap-up
– ब्रेक के दौरान पूर्व-निर्धारित 1-1 मेंटरिंग

रजिस्ट्रेशन अभी खुला है: https://forms.gle/wwrdQNRJYpffNKtb6
